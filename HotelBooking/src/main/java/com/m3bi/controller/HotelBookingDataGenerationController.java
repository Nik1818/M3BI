...
//	private HotelRoomDAO hotelRoomDAO;
	...
	public void hotelDataGenerator() {
		...
		hotel.setName("Sayaji");
		hotel.setLocation("Indore");
		...
		hotel = hotelDAO.findByName("Sayaji");
